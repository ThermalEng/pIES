...
const SCAFFOLD = `你是 pIES 前端的脚手架实现者。工作目录 /home/mc/Documents/工作文档/pIES/frontend。
...
const FEATURES = [
  {
    key: 'login',
    prompt: `你是 pIES 前端的登录与会话界面实现者。工作目录 /home/mc/Documents/工作文档/pIES/frontend。
...
- 完成后报告文件清单`,
  ...
  {
    key: 'projectlist',
    prompt: `你是 pIES 前端的项目列表页实现者。工作目录 /home/mc/Documents/工作文档/pIES/frontend。
...
- 完成后报告文件清单`,
  ...
  {
    key: 'canvas',
    prompt: `你是 pIES 前端的建模画布实现者。工作目录 /home/mc/Documents/工作文档/pIES/frontend。
...
- 完成后报告文件清单`,
  ...
  {
    key: 'dataconfig',
    prompt: `你是 pIES 前端的数据与配置页实现者。工作目录 /home/mc/Documents/工作文档/pIES/frontend。
...
- 完成后报告文件清单`,
  ...
  {
    key: 'tasksresults',
    prompt: `你是 pIES 前端的任务与结果页实现者。工作目录 /home/mc/Documents/工作文档/pIES/frontend。
...
- 完成后报告文件清单`,
  ...
  {
    key: 'tutorial',
    prompt: `你是 pIES 前端的独立教程页实现者。工作目录 /home/mc/Documents/工作文档/pIES/frontend。
...
const build = await agent(
  `你是 pIES 前端的构建集成者。工作目录 /home/mc/Documents/工作文档/pIES/frontend。
...
2. 修复 TypeScript 错误: 在 docker 内构建:
   - cd /home/mc/Documents/工作文档/pIES && docker compose build frontend

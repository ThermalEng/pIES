...
const PAGE_MESSAGES_ZH: Record<string, string> = {
  ...
  'ies.custom.title': '自定义',
  'ies.custom.desc': '管理你自己的设备模型模板: 创建草稿、在线编辑 YAML、发布不可变 revision, 并在项目「新建模型」中选择使用',
  'ies.custom.create': '创建模板',
  'ies.custom.empty': '暂无模板, 点击「创建模板」开始',
  'ies.custom.status.draft': '草稿',
  'ies.custom.status.published': '已发布',
  'ies.custom.status.disabled': '已停用',
  'ies.custom.draft_rev': '草稿修订',
  'ies.custom.published_rev': '发布版本',
  'ies.custom.revisions': '已发布版本',
  'ies.custom.enable': '启用',
  'ies.custom.disable': '停用',
  'ies.custom.delete': '删除草稿',
  'ies.custom.back': '返回列表',
  'ies.custom.new_template': '新建模板',
  'ies.custom.yaml_label': '模板 YAML(含顶层 inputs 声明)',
  'ies.custom.desc_label': '说明(可选)',
  'ies.custom.desc_placeholder': '简短说明, 不参与引用与计算',
  'ies.custom.validate': '校验',
  'ies.custom.save_draft': '保存草稿',
  'ies.custom.publish': '发布',
  'ies.custom.id_invalid': '设备 ID 格式非法(小写命名空间, 如 acme.device.xxx)',
  'ies.custom.validation_failed': '校验失败, 请查看下方诊断',
  'ies.custom.published_ok': '已发布为不可变 revision',
  'ies.custom.rev_label': 'revision',
  'ies.custom.sha_label': '内容摘要',
  'ies.custom.schema_version': 'schema 版本',
  'ies.custom.inputs': 'inputs 数量'
}
...
const PAGE_MESSAGES_EN: Record<string, string> = {
  ...
  'ies.custom.title': 'Custom',
  'ies.custom.desc': 'Manage your own device model templates: create drafts, edit YAML online, publish immutable revisions, and use them in "New model"',
  'ies.custom.create': 'New template',
  'ies.custom.empty': 'No templates yet. Click "New template" to start',
  'ies.custom.status.draft': 'Draft',
  'ies.custom.status.published': 'Published',
  'ies.custom.status.disabled': 'Disabled',
  'ies.custom.draft_rev': 'Draft revision',
  'ies.custom.published_rev': 'Published version',
  'ies.custom.revisions': 'Published versions',
  'ies.custom.enable': 'Enable',
  'ies.custom.disable': 'Disable',
  'ies.custom.delete': 'Delete draft',
  'ies.custom.back': 'Back to list',
  'ies.custom.new_template': 'New template',
  'ies.custom.yaml_label': 'Template YAML (with top-level inputs declarations)',
  'ies.custom.desc_label': 'Description (optional)',
  'ies.custom.desc_placeholder': 'Short note; not part of references or calculations',
  'ies.custom.validate': 'Validate',
  'ies.custom.save_draft': 'Save draft',
  'ies.custom.publish': 'Publish',
  'ies.custom.id_invalid': 'Invalid device ID (lowercase namespaced, e.g. acme.device.xxx)',
  'ies.custom.validation_failed': 'Validation failed; see the diagnostics below',
  'ies.custom.published_ok': 'Published as an immutable revision',
  'ies.custom.rev_label': 'revision',
  'ies.custom.sha_label': 'Content hash',
  'ies.custom.schema_version': 'schema version',
  'ies.custom.inputs': 'inputs count',
}

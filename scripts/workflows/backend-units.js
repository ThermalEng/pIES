...
const WAVE1 = [
  {
    key: 'auth',
    prompt: `你是 IES Plan 后端的身份与认证单元(U01)实现者。工作目录 /home/mc/Documents/工作文档/IES_Plan/backend。

## 先读(必读)
- /home/mc/Documents/工作文档/IES_Plan/docs/CONTRACT.md
- /home/mc/Documents/工作文档/IES_Plan/iesplan/models/identity.py (users/roles/user_roles/credentials/window_sessions/auth_events 已实现)
- /home/mc/Documents/工作文档/IES_Plan/iesplan/models/audit.py
- /home/mc/Documents/工作文档/IES_Plan/iesplan/core/security.py (hash_password/verify_password/token_hash/new_session_token)
- /home/mc/Documents/工作文档/IES_Plan/iesplan/db.py, iesplan/config.py, iesplan/core/errors.py, iesplan/core/diagnostics.py
...
- 中文注释; 完成后报告文件清单与 API 列表`,
  ...
  {
    key: 'project',
    prompt: `你是 IES Plan 后端的项目单元(U02/U03)实现者。工作目录 /home/mc/Documents/工作文档/IES_Plan/backend。

## 先读(必读)
- /home/mc/Documents/工作文档/IES_Plan/docs/CONTRACT.md
- /home/mc/Documents/工作文档/IES_Plan/iesplan/models/project.py (projects/drafts/project_versions/version_refs), iesplan/models/audit.py
- /home/mc/Documents/工作文档/IES_Plan/iesplan/db.py, iesplan/core/errors.py, iesplan/core/diagnostics.py, iesplan/core/idgen.py
...
- 中文注释; 完成后报告文件清单与 API 列表`,
  ...
  {
    key: 'model',
    prompt: `你是 IES Plan 后端的系统模型单元(U04)实现者。工作目录 /home/mc/Documents/工作文档/IES_Plan/backend。

## 先读(必读)
- /home/mc/Documents/工作文档/IES_Plan/docs/CONTRACT.md
- /home/mc/Documents/工作文档/IES_Plan/iesplan/models/model.py (system_graphs/devices/ports/connections)
- /home/mc/Documents/工作文档/IES_Plan/iesplan/core/registry.py (9 类设备类型与参数 schema)
- /home/mc/Documents/工作文档/IES_Plan/iesplan/db.py, iesplan/core/errors.py, iesplan/core/diagnostics.py
...
- 中文注释; 完成后报告文件清单与 API 列表`,
  ...
  {
    key: 'dataset',
    prompt: `你是 IES Plan 后端的数据集单元(U05)实现者。工作目录 /home/mc/Documents/工作文档/IES_Plan/backend。

## 先读(必读)
- /home/mc/Documents/工作文档/IES_Plan/docs/CONTRACT.md
- /home/mc/Documents/工作文档/IES_Plan/iesplan/models/dataset.py (datasets/dataset_versions/dataset_files), iesplan/models/audit.py
- /home/mc/Documents/工作文档/IES_Plan/iesplan/core/timeaxis.py (TimeAxis/build_axis/validate_timestamps), iesplan/core/diagnostics.py, iesplan/core/idgen.py
- /home/mc/Documents/工作文档/IES_Plan/iesplan/db.py, iesplan/config.py, iesplan/core/errors.py
...
- 中文注释; 完成后报告文件清单与 API 列表`,
  ...
  {
    key: 'config',
    prompt: `你是 IES Plan 后端的计算配置单元(U06)实现者。工作目录 /home/mc/Documents/工作文档/IES_Plan/backend。

## 先读(必读)
- /home/mc/Documents/工作文档/IES_Plan/docs/CONTRACT.md
- /home/mc/Documents/工作文档/IES_Plan/iesplan/models/calc.py (calc_configs 等)
- /home/mc/Documents/工作文档/IES_Plan/iesplan/core/registry.py, iesplan/core/expression.py, iesplan/core/units.py, iesplan/core/errors.py, iesplan/core/diagnostics.py
- /home/mc/Documents/工作文档/IES_Plan/iesplan/db.py
...
const WAVE2 = [
  {
    key: 'validation',
    prompt: `你是 IES Plan 后端的项目校验单元(U07)实现者。工作目录 /home/mc/Documents/工作文档/IES_Plan/backend。

## 先读(必读)
- /home/mc/Documents/工作文档/IES_Plan/docs/CONTRACT.md
- /home/mc/Documents/工作文档/IES_Plan/iesplan/services/model.py, iesplan/services/config.py, iesplan/services/dataset.py (上一波次已实现; 若签名与预期不同, 按实际适配)
- /home/mc/Documents/工作文档/IES_Plan/iesplan/core/diagnostics.py, iesplan/core/errors.py
...
- 中文注释; 完成后报告文件清单与 API 列表`,
  ...
  {
    key: 'tasks',
    prompt: `你是 IES Plan 后端的任务调度单元(U08)实现者。工作目录 /home/mc/Documents/工作文档/IES_Plan/backend。

## 先读(必读)
- /home/mc/Documents/工作文档/IES_Plan/docs/CONTRACT.md
- /home/mc/Documents/工作文档/IES_Plan/docs/spec/03-task-scheduling.md (任务调度完整协议)
- /home/mc/Documents/工作文档/IES_Plan/iesplan/models/calc.py (calc_snapshots/tasks/task_attempts/task_leases/task_progress/task_diagnostics/compute_slots), iesplan/models/result.py
- /home/mc/Documents/工作文档/IES_Plan/iesplan/core/errors.py, iesplan/core/idgen.py, iesplan/core/diagnostics.py, iesplan/config.py, iesplan/db.py
...
- 中文注释; 完成后报告文件清单与 API 列表`,
  ...
  {
    key: 'objects',
    prompt: `你是 IES Plan 后端的对象存储单元(U11)实现者。工作目录 /home/mc/Documents/工作文档/IES_Plan/backend。

## 先读(必读)
- /home/mc/Documents/工作文档/IES_Plan/docs/CONTRACT.md
- /home/mc/Documents/工作文档/IES_Plan/iesplan/models/audit.py (objects/object_refs/audit_log 等)
- /home/mc/Documents/工作文档/IES_Plan/iesplan/config.py, iesplan/core/idgen.py, iesplan/core/errors.py
...
const WAVE3 = [
  {
    key: 'worker',
    prompt: `你是 IES Plan 后端的计算 Worker 实现者。工作目录 /home/mc/Documents/工作文档/IES_Plan/backend。

## 先读(必读)
- /home/mc/Documents/工作文档/IES_Plan/docs/CONTRACT.md
- /home/mc/Documents/工作文档/IES_Plan/docs/spec/03-task-scheduling.md (租约/fencing/队列协议)
- /home/mc/Documents/工作文档/IES_Plan/iesplan/engines/eval_run.py, iesplan/engines/planning.py, iesplan/metrics/financial.py, iesplan/metrics/environmental.py, iesplan/metrics/engineering.py (基础层已实现)
- /home/mc/Documents/工作文档/IES_Plan/iesplan/services/tasks.py, iesplan/services/queue.py, iesplan/services/objects.py (上一波次实现; 签名以实际为准)
- /home/mc/Documents/工作文档/IES_Plan/iesplan/core/timeaxis.py, iesplan/core/diagnostics.py, iesplan/config.py, iesplan/db.py
...
- 中文注释; 完成后报告文件清单`,
  ...
  {
    key: 'results',
    prompt: `你是 IES Plan 后端的证据与结果单元(U12/U13/U14)实现者。工作目录 /home/mc/Documents/工作文档/IES_Plan/backend。

## 先读(必读)
- /home/mc/Documents/工作文档/IES_Plan/docs/CONTRACT.md
- /home/mc/Documents/工作文档/IES_Plan/iesplan/models/result.py (evidence_packages/result_assessments/result_index/result_selections/reports)
- /home/mc/Documents/工作文档/IES_Plan/iesplan/metrics/validity.py (四维状态), iesplan/metrics/financial.py
- /home/mc/Documents/工作文档/IES_Plan/iesplan/services/objects.py, iesplan/services/tasks.py (签名以实际为准)
...
- 中文注释; 完成后报告文件清单与 API 列表`,
  ...
  {
    key: 'package',
    prompt: `你是 IES Plan 后端的项目包单元(U15)与审计单元(U16)实现者。工作目录 /home/mc/Documents/工作文档/IES_Plan/backend。

## 先读(必读)
- /home/mc/Documents/工作文档/IES_Plan/docs/CONTRACT.md
- /home/mc/Documents/工作文档/IES_Plan/iesplan/models/audit.py (audit_log/import_proposals/retention_rules 等), iesplan/models/project.py, iesplan/models/result.py
- /home/mc/Documents/工作文档/IES_Plan/iesplan/services/objects.py, iesplan/services/project.py, iesplan/services/dataset.py (签名以实际为准)
...
const integration = await agent(
  `你是 IES Plan 后端的全量集成验证者。工作目录 /home/mc/Documents/工作文档/IES_Plan。

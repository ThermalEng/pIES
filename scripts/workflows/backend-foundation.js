...
const WORK = [
  {
    key: 'config-db',
    prompt: `你是 IES Plan 后端的数据层实现者。工作目录 /home/mc/Documents/工作文档/IES_Plan/backend。

## 先读(必读)
- /home/mc/Documents/工作文档/IES_Plan/docs/CONTRACT.md (实现契约, 必须遵守, 尤其是第2节接口签名与第3节数据约定)
- /home/mc/Documents/工作文档/IES_Plan/docs/spec/01-db-schema.md (数据库权威事实关系模式, 全部 41 张表的列/约束/索引定义)
...
- 用中文注释; 类型标注完整; 完成后报告创建的文件清单`,
  ...
  {
    key: 'core',
    prompt: `你是 IES Plan 后端的核心工具层实现者。工作目录 /home/mc/Documents/工作文档/IES_Plan/backend。

## 先读(必读)
- /home/mc/Documents/工作文档/IES_Plan/docs/CONTRACT.md (实现契约 第2节接口签名必须精确实现, 第3节数据约定)
- /home/mc/Documents/工作文档/IES_Plan/docs/spec/02-calc-model.md (时间轴 第1节, 单位 第2节)
- /home/mc/Documents/工作文档/IES_Plan/docs/spec/04-registry-diagnostics.md (注册表 第2-3节, 表达式 第4节, 诊断 第5节, 单位 第8节)
...
- 中文注释, 类型标注完整; 完成后报告文件清单`,
  ...
  {
    key: 'engines',
    prompt: `你是 IES Plan 后端的计算引擎实现者。工作目录 /home/mc/Documents/工作文档/IES_Plan/backend。

## 先读(必读)
- /home/mc/Documents/工作文档/IES_Plan/docs/CONTRACT.md (第2节接口签名: TimeAxis, SolveResult, solve_milp, solve_lp, evaluate_plan, EvalResult; 第3节数据约定)
- /home/mc/Documents/工作文档/IES_Plan/docs/spec/02-calc-model.md (第1节时间轴, 第3节能量平衡, 第4节设备模型, 第5节 MILP 构建, 第7节任意方案评价, 第8节逐时结果字段, 第9节收敛停止)
- /home/mc/Documents/工作文档/IES_Plan/docs/spec/04-registry-diagnostics.md (第3节设备参数 schema)
...
- 中文注释; 类型标注完整; 完成后报告文件清单`,
  ...
  {
    key: 'metrics',
    prompt: `你是 IES Plan 后端的财务/环境/工程指标实现者。工作目录 /home/mc/Documents/工作文档/IES_Plan/backend。

## 先读(必读)
- /home/mc/Documents/工作文档/IES_Plan/docs/CONTRACT.md (第2节接口签名: IRRStatus, cashflow_irr, operational_emissions; 第3节数据约定: 金额 Decimal)
- /home/mc/Documents/工作文档/IES_Plan/docs/spec/02-calc-model.md (第5.2-5.4节目标函数与现金流, 第8节逐时结果与 KPI)
- /home/mc/Documents/工作文档/IES_Plan/docs/spec/01-db-schema.md (第8.2节 result_assessments 四维状态枚举)
...
- 中文注释; 类型标注完整; 完成后报告文件清单`,
  ...
  {
    key: 'api-stub',
    prompt: `你是 IES Plan 后端的应用入口实现者。工作目录 /home/mc/Documents/工作文档/IES_Plan/backend。

## 先读(必读)
- /home/mc/Documents/工作文档/IES_Plan/docs/CONTRACT.md (整体约定)
...
const integration = await agent(
  `你是 IES Plan 后端的集成验证者。工作目录 /home/mc/Documents/工作文档/IES_Plan。
...
3. 用 Docker 构建测试环境并运行测试:
   - 在 /home/mc/Documents/工作文档/IES_Plan 下执行: docker compose build backend  (只构建后端镜像, 不启动全部)
